...
class BudgetTrackerController:
    ...
    @classmethod   
    def create_new_budget_tracker(cls, acct_id):
        ...
        if form.validate_on_submit():
            ...
            if today_date.day == 1:
                ...
                amount_spent = specified_acct.get_amount_spent_for_account(today_date.replace(day=1), today_date, g.user.account_type)
            try:
    ...
    @classmethod
    def update_existing_budget_tracker(cls, acct_id):
        """
        Displays form for a user to enter parameters for a budget tracker for their account
