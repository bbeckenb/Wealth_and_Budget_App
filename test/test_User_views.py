...
class UserViewTestCase(TestCase):
    ...
    def test_signup_form_renders(self):
        ...
        self.assertIn('<button class="btn btn-outline-primary">Sign up</button>', html)
    ...
    def test_logout_wit_user_in_session(self):
        ...
        # self.assertNotIn("curr_user", sess) # Need to finish test by checking what is in session
